...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:mods="http://www.loc.gov/mods/v3" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
    ...
    <xsl:template match="RECORD" mode="record">
        ...
        <mods:mods>
            ...
            <mods:note type="doc type">Chapter</mods:note> <!--on the same line to eliminate spaces -->
            <!-- Authors -->
            <xsl:apply-templates select="ANALYTIC_LEVEL_author_s_ | MONOGRAPHIC_LEVEL_author_s_">
    ...
    <!-- Document Type C Specific Layout -->
    <xsl:template match="RECORD" mode="C">
        <mods:typeOfResource>text</mods:typeOfResource>
        <mods:relatedItem type="host">
            <xsl:apply-templates select="Monographic_source_author_s_">
                <xsl:with-param name="sType">personal</xsl:with-param>
                <xsl:with-param name="sRole">Editor</xsl:with-param>
                <xsl:with-param name="sDocType">C</xsl:with-param>
            </xsl:apply-templates>
            <xsl:apply-templates select="Corporate_source_author_s_">
                <xsl:with-param name="sType">corporate</xsl:with-param>
                <xsl:with-param name="sRole">Editor</xsl:with-param>
                <xsl:with-param name="sDocType">C</xsl:with-param>
            </xsl:apply-templates>
            ...
            <xsl:apply-templates select="Extent_of_chapter" mode="part" />
            <xsl:apply-templates select="Other_pagination[not(../Extent_of_chapter)]" mode="part" />
        </mods:relatedItem>
    
    </xsl:template>
    <!-- End Document Type C Specific Layout -->
    ...
    <xsl:template match="ANALYTIC_LEVEL_author_s_">
